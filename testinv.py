...
def main():
    ...
    inner_boundingbox = bounding_box(list_of_points2)
    outer_boundingbox = bounding_box(list_of_points)
    vortdivinv = vortdiv_inversion(u850,v850,outer_boundingbox,inner_boundingbox)
    vortdivinv.set_data()
